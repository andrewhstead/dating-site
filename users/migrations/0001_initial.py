# Generated by Django 2.2.4 on 2019-08-09 20:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stripe_id', models.CharField(blank=True, default='', max_length=40, null=True)),
                ('subscription_ends', models.DateTimeField(blank=True, null=True)),
                ('subscription_renews', models.BooleanField(default=False)),
                ('subscription_plan', models.CharField(blank=True, max_length=25, null=True)),
